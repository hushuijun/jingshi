<template>
  <div class="task oa-bgcolor">
    <div class="header">
      <el-button type="primary" class="new-btn" @click="newBtn">新建任务</el-button>
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane :label="item.label" :name="item.key" v-for="(item, index) in tabData" :key="index">
          <my-task v-loading="loading" :list="listData" :listType="item.key" :ref="item.key" :subUserListData="subUserListData" :loadMoreLoading="loadMoreLoading" @selectChange="selectChange">
            <div class="search-input" slot="searchInput">
              <el-input size="medium" placeholder="搜索任务名称" suffix-icon="el-icon-search" v-model="searchValue" @input="searchChange">
              </el-input>
            </div>
          </my-task>
        </el-tab-pane>
    ...
    <!-- 新增任务弹出框 newDialog-->
    <new-dialog :newDialogVisible="dialogVisible" :newLoading="newLoading" @handleClose="handleClose" @dialogVisibleSubmit="dialogVisibleSubmit">
    </new-dialog>
  </div>
</template>
